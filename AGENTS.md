...
### 教训 #1：Session 启动时未重新读取 AGENTS.md，TODO 管理缺失
...
**具体违规**：
1. 本次会话开始时，基于历史上下文直接执行，未重新读取项目 AGENTS.md
2. 用户确认"开始吧"后，未将任务整理到 AGENTS.md 的 TODO 中，直接开始修改文件
...
**正确做法**：
1. 每个 Session 开始时，必须完整阅读项目 AGENTS.md
2. 用户确认执行后，先将任务写入 AGENTS.md 的 TODO 再开始执行
3. 每完成一项任务，立即更新 TODO 状态

**预防措施**：
- 在自检清单中增加："☐ Session 开始时是否已重新读取 AGENTS.md？"
- 在自检清单中增加："☐ 执行前是否已将 TODO 写入 AGENTS.md？"
